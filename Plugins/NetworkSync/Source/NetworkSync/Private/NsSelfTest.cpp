...
FNsSelfTestResult NsRunAllSelfTests()
{
	...
	const FFn Fns[] = {
		...
		&NsRunStunRelaySelfTest,
		&NsRunStunIceSelfTest,
		&NsRunStunIceExchangeSelfTest,
		&NsRunStunIcePairsSelfTest,
		&NsRunStunIceNominateSelfTest,
		&NsRunStunHubSelfTest,
		&NsRunStunHubProcessSelfTest,
		&NsRunStunIceSdpSelfTest,
