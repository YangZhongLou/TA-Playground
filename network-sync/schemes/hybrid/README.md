...
| 通信回合停拍拉齐 | [turn-resync.md](turn-resync.md) | [../../impl/hybrid/turn-resync.md](../../impl/hybrid/turn-resync.md) | `NsLockstepTurnResync.*` |
| 锁步加门 | [door.md](door.md) | [../../impl/hybrid/door.md](../../impl/hybrid/door.md) | `NsLockstepDoor.*`（FakeNet 门） |

不要开「英雄快照 + 小兵锁步」那种双 `F` 包。那是同一战场两套结算。
等齐 / 通信回合 / delay 停拍拉齐不是第五套主方案，也不是新 Kind：同一类切法叠在对应内核上，单独成包。
