...
已实现的一支：[lockstep.md](lockstep.md)（乐观 15Hz）。
...
| `CommTurn` | 通信回合 + 两回合提前 | [lockstep-comm-turn.md](lockstep-comm-turn.md) | 未做：新 `NsLsTurn.*` |
| `DelayBased` | 等齐 + 固定 `d` 拍缓冲 | [lockstep-delay.md](lockstep-delay.md) | 未做：新 `NsLsDelay.*` |
